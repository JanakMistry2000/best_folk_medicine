...
class Utils {
  static GlobalKey<NavigatorState> incdecnavi = GlobalKey();
  ...
  static Future<List<ArticleDataModel>> getArticles() async {
    ...
    String data1 =
        await rootBundle.loadString("lib/assets/data/article_data.json");
  ...
  static Future<List<CategoryDataModel>> getCategory() async {
    ...
    String data1 =
        await rootBundle.loadString("lib/assets/data/category_data.json");
    final jsonResult = await jsonDecode(data1);
    for (var article in jsonResult) {
